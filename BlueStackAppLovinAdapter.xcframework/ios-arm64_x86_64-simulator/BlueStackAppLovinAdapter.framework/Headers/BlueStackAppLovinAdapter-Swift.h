...
#ifndef BLUESTACKAPPLOVINADAPTER_SWIFT_H
#define BLUESTACKAPPLOVINADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BlueStackAppLovinAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC24BlueStackAppLovinAdapter13BlueStackKeys")
@interface BlueStackKeys : NSObject
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull locationConsentFlag;)
+ (NSString * _Nonnull)locationConsentFlag SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull viewController;)
+ (NSString * _Nonnull)viewController SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull bannerPreferredHeight;)
+ (NSString * _Nonnull)bannerPreferredHeight SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC24BlueStackAppLovinAdapter25BlueStackMediationAdapter")
@interface BlueStackMediationAdapter : ALMediationAdapter
...
@interface BlueStackMediationAdapter (SWIFT_EXTENSION(BlueStackAppLovinAdapter)) <MAAdViewAdapter>
- (void)loadAdViewAdForParameters:(id <MAAdapterResponseParameters> _Nonnull)parameters adFormat:(MAAdFormat * _Nonnull)adFormat andNotify:(id <MAAdViewAdapterDelegate> _Nonnull)delegate;
@end

@protocol MARewardedAdapterDelegate;

@interface BlueStackMediationAdapter (SWIFT_EXTENSION(BlueStackAppLovinAdapter)) <MARewardedAdapter>
...
@interface BlueStackMediationAdapter (SWIFT_EXTENSION(BlueStackAppLovinAdapter)) <MAInterstitialAdapter>
